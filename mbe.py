...
# nelem         number of energies to process
# reverse	should we do the summation beckwards?
# hassym	do the data contain symmetry factor?
#
...
def sum_energies_file_NN(dirfile,enfile,idxdist,idxdata,idxsym,dist_lim,nelem,reverse=False,hassym=True):
   ...
   # guess the fragment size
   # and set the number of groups based on contact-distance
   if idxdist==2:
      nfrag=2
      ngroup=2
   elif idxdist==5:
...
###############################
##
# read a trimer file and calculate the ATM factor assuming average distance 
